...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,designation=:designation,
Country=:Country,Phonenumber=:mobileno where EmailId=:eid";
...
<input id="designation" name="designation" type="text"  value="<?php echo htmlentities($result->designation);?>" autocomplete="off" required>
</div>
